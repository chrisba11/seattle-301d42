...
function displayPics(){
  ...
  // The previous console.log line of code threw an error because when we switched to `let`, the scope of `rando` changed to be bound within the while statement of this function.
  console.log(viewed);
